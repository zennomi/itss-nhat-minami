...
export const prices = [0, 2000 , 4000 , 6000 , 8000 , 10000 ];

export const sex =['男性','女性','何でも'];
...
export const flagLanguageImg = {
        ...
        'Japanese' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Flag_of_Japan.svg/1200px-Flag_of_Japan.svg.png',
